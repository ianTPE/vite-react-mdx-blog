...
const AboutPage: React.FC = () => {
  ...
  backgroundPosition: 'center',
                ...
                <div className="w-56 h-56 rounded-full overflow-hidden ring-4 ring-white shadow-lg">
                  <img 
                    ...
                    onError={(e) => {
                      ...
                      target.outerHTML = `<div class="w-full h-full bg-gradient-to-br from-blue-400 to-indigo-600 flex items-center justify-center text-white text-6xl font-bold">I</div>`;
                    }}
                  />
                </div>
              </div>
              ...
              <div className="p-8 md:p-12 md:w-3/5">
                <h2 className="text-3xl font-bold mb-4 text-gray-800">嗨，我是 Ian <span className="wave">👋</span></h2>
                <p className="text-gray-700 mb-6 text-lg">
                  我是一位充滿熱情的全端開發者，喜歡探索和分享最新的網頁技術。擁有超過十年的產品經理經驗，專注於 React 生態系統、現代化前端架構、AI輔助開發和自動化流程。
                </p>
